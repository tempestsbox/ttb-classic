...
execute as @e[tag=set_structure] at @s unless block ~7 ~-1 ~7 #ttb:ignore unless block ~ ~-1 ~22 #ttb:ignore unless block ~7 ~-1 ~ #ttb:ignore if block ~7 ~1 ~7 #ttb:ignore if block ~ ~1 ~22 #ttb:ignore if block ~7 ~1 ~ #ttb:ignore unless block ~ ~-1 ~ #ttb:leaves run fill ~ ~-1 ~ ~7 ~-10 ~7 sand replace #ttb:ignore
execute as @e[tag=set_structure] at @s unless block ~7 ~-1 ~7 #ttb:ignore unless block ~ ~-1 ~22 #ttb:ignore unless block ~7 ~-1 ~ #ttb:ignore if block ~7 ~1 ~7 #ttb:ignore if block ~ ~1 ~7 #ttb:ignore if block ~7 ~1 ~ #ttb:ignore unless block ~ ~-1 ~ #ttb:leaves run setblock ~ ~-1 ~ structure_block{ignoreEntities: 0b, powered: 0b, posX: 0, mode: "LOAD", posY: 0, posZ: 0, name: "desert/surface/11", id: "minecraft:structure_block", showboundingbox: 1b}

...
execute as @e[tag=set_structure] at @s unless block ~7 ~-1 ~7 #ttb:ignore unless block ~ ~-1 ~22 #ttb:ignore unless block ~7 ~-1 ~ #ttb:ignore if block ~7 ~1 ~7 #ttb:ignore if block ~ ~1 ~22 #ttb:ignore if block ~7 ~1 ~ #ttb:ignore unless block ~ ~-1 ~ #ttb:leaves run fill ~ ~-2 ~ ~7 ~-11 ~7 grass_block replace #ttb:ignore
execute as @e[tag=set_structure] at @s unless block ~7 ~-1 ~7 #ttb:ignore unless block ~ ~-1 ~22 #ttb:ignore unless block ~7 ~-1 ~ #ttb:ignore if block ~7 ~1 ~7 #ttb:ignore if block ~ ~1 ~7 #ttb:ignore if block ~7 ~1 ~ #ttb:ignore unless block ~ ~-1 ~ #ttb:leaves run setblock ~ ~-1 ~ structure_block{ignoreEntities: 0b, powered: 0b, posX: 0, mode: "LOAD", posY: -1, posZ: 0, name: "plains/surface/8", id: "minecraft:structure_block", showboundingbox: 1b}

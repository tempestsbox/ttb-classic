...
execute as @e[tag=set_structure] at @s unless block ~15 ~-1 ~15 #ttb:ignore unless block ~ ~-1 ~22 #ttb:ignore unless block ~15 ~-1 ~ #ttb:ignore if block ~15 ~1 ~15 #ttb:ignore if block ~ ~1 ~22 #ttb:ignore if block ~15 ~1 ~ #ttb:ignore unless block ~ ~-1 ~ #ttb:leaves run fill ~ ~-7 ~ ~15 ~-16 ~15 grass_block replace #ttb:ignore
execute as @e[tag=set_structure] at @s unless block ~15 ~-1 ~15 #ttb:ignore unless block ~ ~-1 ~22 #ttb:ignore unless block ~15 ~-1 ~ #ttb:ignore if block ~15 ~1 ~15 #ttb:ignore if block ~ ~1 ~15 #ttb:ignore if block ~15 ~1 ~ #ttb:ignore unless block ~ ~-1 ~ #ttb:leaves run setblock ~ ~-1 ~ structure_block{ignoreEntities: 0b, powered: 0b, posX: 0, mode: "LOAD", posY: -6, posZ: 0, name: "swamp/surface/1", id: "minecraft:structure_block", showboundingbox: 1b}

...
execute @s ~ ~ ~ detect ~ ~-1 ~ cobblestone 0 summon item ~ ~-1 ~ {Item:{Count:2b,Damage:0s,id:"minecraft:gravel"}}
...
execute @s ~ ~ ~ detect ~ ~-1 ~ log 0 summon item ~ ~-1 ~ {Item:{Count:6b,Damage:0s,id:"minecraft:planks"}}
execute @s ~ ~ ~ detect ~ ~-1 ~ log 1 summon item ~ ~-1 ~ {Item:{Count:6b,Damage:1s,id:"minecraft:planks"}}
execute @s ~ ~ ~ detect ~ ~-1 ~ log 2 summon item ~ ~-1 ~ {Item:{Count:6b,Damage:2s,id:"minecraft:planks"}}
execute @s ~ ~ ~ detect ~ ~-1 ~ log 3 summon item ~ ~-1 ~ {Item:{Count:6b,Damage:3s,id:"minecraft:planks"}}
execute @s ~ ~ ~ detect ~ ~-1 ~ log2 0 summon item ~ ~-1 ~ {Item:{Count:6b,Damage:4s,id:"minecraft:planks"}}
execute @s ~ ~ ~ detect ~ ~-1 ~ log2 1 summon item ~ ~-1 ~ {Item:{Count:6b,Damage:5s,id:"minecraft:planks"}}
execute @s ~ ~ ~ detect ~ ~-1 ~ planks -1 summon item ~ ~-1 ~ {Item:{Count:12b,Damage:0s,id:"minecraft:stick"}}
execute @s ~ ~ ~ detect ~ ~-1 ~ pumpkin -1 summon item ~ ~-1 ~ {Item:{Count:8b,Damage:0s,id:"minecraft:pumpkin_seeds"}}
...
execute @s ~ ~ ~ detect ~ ~-1 ~ grass -1 summon item ~ ~-1 ~ {Item:{Count:12b,Damage:0s,id:"minecraft:wheat_seeds"}}
...
execute @s ~ ~ ~ detect ~ ~-1 ~ magma -1 summon bat ~ ~-1 ~ {CustomName:"isMacerateItem",NoAI:1,Silent:1,Health:1.0F,DeathLootTable:"minecraft:macerate/magma2",ActiveEffects:[{Id:14,Amplifier:0,Duration:200}]}
execute @s ~ ~ ~ detect ~ ~-1 ~ soul_sand -1 summon bat ~ ~-1 ~ {CustomName:"isMacerateItem",NoAI:1,Silent:1,Health:1.0F,DeathLootTable:"minecraft:macerate/soul_sand2",ActiveEffects:[{Id:14,Amplifier:0,Duration:200}]}
execute @s ~ ~ ~ detect ~ ~-1 ~ mossy_cobblestone -1 summon bat ~ ~-1 ~ {CustomName:"isMacerateItem",NoAI:1,Silent:1,Health:1.0F,DeathLootTable:"minecraft:macerate/mossy_cobblestone2",ActiveEffects:[{Id:14,Amplifier:0,Duration:200}]}
execute @s ~ ~ ~ detect ~ ~-1 ~ stonebrick 1 summon bat ~ ~-1 ~ {CustomName:"isMacerateItem",NoAI:1,Silent:1,Health:1.0F,DeathLootTable:"minecraft:macerate/mossy_cobblestone2",ActiveEffects:[{Id:14,Amplifier:0,Duration:200}]}
execute @s ~ ~ ~ detect ~ ~-1 ~ monster_egg 3 summon bat ~ ~-1 ~ {CustomName:"isMacerateItem",NoAI:1,Silent:1,Health:1.0F,DeathLootTable:"minecraft:macerate/mossy_cobblestone2",ActiveEffects:[{Id:14,Amplifier:0,Duration:200}]}
execute @s ~ ~ ~ detect ~ ~-1 ~ cobblestone_wall -1 summon bat ~ ~-1 ~ {CustomName:"isMacerateItem",NoAI:1,Silent:1,Health:1.0F,DeathLootTable:"minecraft:macerate/mossy_cobblestone2",ActiveEffects:[{Id:14,Amplifier:0,Duration:200}]}

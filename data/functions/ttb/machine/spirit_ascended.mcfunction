...
# Author: Jragon
# Date: May 18th 2017
# Description: Ascended Spirit infuser. Takes an item and summons a squid which stores another
# item.
################################################################################################################
...
execute @s[tag=inUse] ~-10 ~-10 ~-10 scoreboard players remove @e[tag=macContainer,score_power_min=1,c=1,dx=20,dy=20,dz=20] power 2

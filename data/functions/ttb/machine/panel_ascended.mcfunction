...
execute @s[tag=foundSky] ~ ~ ~ summon bat ~ ~ ~ {CustomName:"ENsun",Tags:["ENsun"],NoGravity:1,NoAI:1,Silent:1b,ActiveEffects:[{Id:14,Amplifier:0,Duration:200}],DeathLootTable:"minecraft:attribute/tempite2"}
